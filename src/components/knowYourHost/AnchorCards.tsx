          ...
          <Link key={index} href={card.link} className="md:basis-[50%]">
            <div className="group perspective">
              <div className="relative w-full transition-transform">
                <div
                  className="bg-[#0D031B] p-10 h-[485px] flex flex-col justify-end items-start text-left bg-cover bg-center-top transition-colors duration-300 ease-in-out"
                ...
                >
                  <div className="flex flex-row flex-wrap items-end justify-between w-full">
                    <div className="md:basis-10/12">
                      <h3 className="md:text-h3 font-antonio text-h6 font-normal mt-5">
                        {card.title}
                      </h3>
                    </div>
