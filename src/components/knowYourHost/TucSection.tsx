  ...
  return (
    <div>
      <div
        id="be-a-guest"
        ref={sectionRef}
        className="relative px-4 md:px-20 bg-[url('/images/know-your-host/tucbg.webp')] bg-contain md:bg-cover bg-center md:bg-top"
      >
        <div
        ...
        <div className="relative px-4 md:px-10 py-10 md:pt-[395px] md:pb-[265px] container mx-auto">
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            ...
            >
              <span className="bg-gradient-to-r from-sky-500 to-purple-500 bg-clip-text text-transparent"></span>
            </h3>
